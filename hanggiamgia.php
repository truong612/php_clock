...
<body>
	...
	<main>
        ...
        <section class="content">
            ...
            // Truy vấn sản phẩm
            $sql = "SELECT * FROM sanpham Where hanggiamgia='1'";
            ...
            if ($result->num_rows > 0) {
                while($row = $result->fetch_assoc()) {
                    ...
                    echo "<h2>" . $row["ten_san_pham"] . "</h2>";
                    echo "<p>Giá: <del>" . number_format($row["gia"], 0, '.', ',') . " VND</del></p>";
                    echo "<p>Giá giảm: " . number_format($row["gia"] * (1-($row["giamgia"]/100)), 0, '.', ',') . " VND</p>";
